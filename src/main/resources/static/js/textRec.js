                    ...
                    imgObj.onload = function () {
                        ...
                        if (bgJsonData.results[imgIdx] !== undefined) {
                            ...
                            for (var i = 0; i < box[0].length; i++) {
                                for (j = 0; j < box[0][i].length - 1; j++) {
                                    ctx.beginPath();
                                    ctx.moveTo((500 / imgW[imgIdx]) * box[0][i][j][0], (312 / imgH[imgIdx]) * box[0][i][j][1]);
                                    ctx.lineTo((500 / imgW[imgIdx]) * box[0][i][j + 1][0], (312 / imgH[imgIdx]) * box[0][i][j + 1][1]);
                                    ctx.closePath();
                                    ctx.stroke();
                                }

                                ctx.beginPath();
                                ctx.moveTo((500 / imgW[imgIdx]) * box[0][i][0][0], (312 / imgH[imgIdx]) * box[0][i][0][1]);
                                ctx.lineTo((500 / imgW[imgIdx]) * box[0][i][j][0], (312 / imgH[imgIdx]) * box[0][i][j][1]);
                                ctx.closePath();
                                ctx.stroke();
                            }
                        }
