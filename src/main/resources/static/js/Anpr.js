    ...
    $.ajax({
        ...
        success: function(json){
            for(var i = 0; i < json.image_count-1; i++) {
                ...
                imgName.innerHTML = json.image_name[i];
                ...
                thumbnailLi.id = json.image_name[i];
                
                thumbnail.src = "divusImages/evaluation/thumbnail/"+json.image_name[i];
                thumbnail.width = 100;
                    ...
                    selectedImg.addEventListener("click", (e) => {
                        ...
                        $.ajax({
                            ...
                            success: function(json){
                                ...
                                const type = json.results[0].anpr;

                                for(var i = 0; i < type.length; i++){
                                    let rect = document.createElement("span");
                                    let box = json.results[0].anpr[i];
