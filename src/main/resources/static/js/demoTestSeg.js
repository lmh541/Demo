                    ...
                    selectedImg.addEventListener("click", (e) => {
                        ...
                        $.ajax({
                            ...
                            success: function(json){
                                ...
                                // console.log("data:image/jpg;base64,"+json.car_seg[0]);
                                const carSegImg = document.createElement("img");
                                carSegImg.src = "data:;;base64,"+json.car_seg[0];
                                carSegImg.style.width = "100%";
                                carSegImg.style.height = "100%";
                                resultCarSeg.appendChild(carSegImg);
